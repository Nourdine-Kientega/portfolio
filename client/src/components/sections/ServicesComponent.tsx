    ...
    <section className="services" id="services">
        ...
        <div className="services-container">
            <div className="services-box"> 
                ...
                <p>
                    Je propose des solutions en développement web, tant en frontend qu’en backend. Passionné par la création 
            ...
            <div className="services-box">
                ...
                <p>
                    En backend, j’ai une bonne expérience avec Node.js, Express.js, et la gestion de bases de données comme MongoDB et 
